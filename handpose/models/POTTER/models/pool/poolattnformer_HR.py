...
class PoolFormerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.token_mixer = PoolAttn(
            ...
            save_inter_flag=self.save_inter_flag,
            block=self.block,
        ...
        self.Block1 = nn.Sequential(
            *[
                PoolFormerBlock(
                    ...
                    use_layer_scale=use_layer_scale,
                    layer_scale_init_value=layer_scale_init_value,
                    save_inter_flag=save_inter_res,
                    block=1,
                    sub_idx=i,
                )
...
def save_inter(
    tensor,
    name,
    output_dir="/home/jinxu/code/potter-pose-baseline/human_mesh_recovery/output/PAT_vis/inter_feature_map",
):
